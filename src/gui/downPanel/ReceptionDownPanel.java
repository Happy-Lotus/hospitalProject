        ...
        addReception.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(e.getActionCommand().equals("접수")) {
                    ...
                    else if(Main.receptionMgr.find(texts[1])!=null && Main.receptionMgr.find(texts[2])!=null){
                        resultStr = JOptionPane.showInputDialog("환자코드와 이름이 일치하지 않습니다. 환자 코드를 다시 입력해주세요.");
