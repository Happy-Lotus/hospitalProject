...
import gui.tab.DoctorTab;
import gui.tab.PatientTab;
import gui.tab.ReceptionTab;
import gui.tab.ReservationTab;
...
public class GUIMain {
     ...
     */
    public static JFrame mainFrame = new JFrame("병원 환자 관리 프로그램");
