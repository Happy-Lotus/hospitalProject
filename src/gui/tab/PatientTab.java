...
import gui.downPanel.PatientDownPanel;
import gui.main.MenuPage;
import gui.table_demo.ReceptionOfPatientTableDemo;
import gui.table_demo.ReservationOfPatientTableDemo;
import gui.table_demo.TableSelectionDemo;
import gui.topPanel.SearchTopPanel;
import gui.topPanel.VaccinationTopPanel;
...
public class PatientTab {
    ...
    public ReceptionOfPatientTableDemo rpListTable = new ReceptionOfPatientTableDemo();
    public SearchTopPanel patientTop = new SearchTopPanel();
    ...
    public ReservationOfPatientTableDemo v_rListTable = new ReservationOfPatientTableDemo();
    public VaccinationTopPanel v_patientTop = new VaccinationTopPanel();
